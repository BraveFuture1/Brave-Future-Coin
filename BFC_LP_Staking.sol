...
contract BFC_LP_Staking {
    ...
    uint256 public REDUCE_BONUS_DURATION = 10800; //30d 减产周期
    uint256 public BONUS_DURATION = 3600; //1d 分红周期
    uint256 public DEPOSIT_DURATION_1 = 600; //30d 质押周期1
    uint256 public DEPOSIT_DURATION_2 = 1200; //60d 质押周期2
    uint256 public DEPOSIT_DURATION_3 = 1800; //90d 质押周期3
